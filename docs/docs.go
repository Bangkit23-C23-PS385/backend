...
const docTemplate = `{
    ...
    "paths": {
        "/v1/answers": {
            "post": {
                "description": "Used to insert an answer by candidate. This endpoint must be hit every time a candidate submit their answer\nThis will return a presigned url for uploading candidate's video",
                "tags": [
                    "Answer"
                ],
        ...
        "/v1/kits/detail": {
            "get": {
                "description": "Get a detailed interview kit containing its name and questions associated with it",
                "tags": [
                    "Interview Kit"
                ],
